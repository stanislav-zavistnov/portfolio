...
tl.to('.burger__line-top, .burger__line-bottom', { top: 23, duration: 0.25 })
  .fromTo('.burger-background', { display: 'none', opacity: 0, y: -100, }, { display: 'block', opacity: 1, y: 0, duration: 0.1, ease: "expo", })
